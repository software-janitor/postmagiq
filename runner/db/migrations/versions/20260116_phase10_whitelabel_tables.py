...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_whitelabel_configs_workspace_id",
        "whitelabel_configs",
        ["workspace_id"],
        unique=True,
    )
    op.create_index(
        "ix_whitelabel_configs_custom_domain", "whitelabel_configs", ["custom_domain"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_whitelabel_assets_workspace_id", "whitelabel_assets", ["workspace_id"]
    )
    op.create_index(
        "ix_whitelabel_assets_asset_type", "whitelabel_assets", ["asset_type"]
    )
    op.create_index(
