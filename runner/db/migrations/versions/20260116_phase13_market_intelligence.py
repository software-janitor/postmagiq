...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        ),  # voice_sample, content, research, vocabulary
        sa.Column("source_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column(
            "embedding", postgresql.ARRAY(sa.Float), nullable=False
        ),  # vector(1536) stored as float array
    ...
    op.create_table(
        ...
        sa.Column(
            "profile", postgresql.JSON(), nullable=False
        ),  # demographics, psychographics, language_profile, etc.
    ...
    op.create_index(
        "ix_audience_segments_workspace_id", "audience_segments", ["workspace_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "voice_spec", postgresql.JSON(), nullable=False
        ),  # preservation, adaptations, synthesis_rules, examples
        ...
        sa.ForeignKeyConstraint(
            ["segment_id"], ["audience_segments.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "workspace_id",
            ...
            "segment_id",
            "platform",
            name="uq_calibrated_voice",
        ),
    )
    op.create_index(
        "ix_calibrated_voices_workspace_id", "calibrated_voices", ["workspace_id"]
    )
    op.create_index(
        "ix_calibrated_voices_lookup",
        "calibrated_voices",
        ["workspace_id", "segment_id", "platform"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "sentiment", sa.String(20), nullable=True
    ...
    op.create_index(
        "ix_niche_vocabulary_workspace_id", "niche_vocabulary", ["workspace_id"]
    )
    op.create_index(
        "ix_niche_vocabulary_term", "niche_vocabulary", ["workspace_id", "term"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "source_type", sa.String(50), nullable=False
        ),  # llm_niche, llm_competitor, user_provided
        sa.Column("source_identifier", sa.String(255), nullable=False),
        sa.Column("raw_data", postgresql.JSON(), nullable=True),
        sa.Column(
            "processed_insights", postgresql.JSON(), nullable=True
        ),  # vocabulary_extracted, pain_points, patterns
        sa.Column(
            "collected_at", sa.DateTime(), nullable=False, server_default=sa.func.now()
        ),
        ...
        sa.UniqueConstraint(
            ...
            "source_type",
            "source_identifier",
            name="uq_research_source",
        ),
    )
    op.create_index(
        "ix_research_sources_workspace_id", "research_sources", ["workspace_id"]
    )
    ...
    op.create_table(
        ...
        ),  # Link to posts table if published
        sa.Column(
            "content_type", sa.String(50), nullable=False
        ),  # post, image, video_script
        sa.Column("platform", sa.String(50), nullable=False),
        ...
        sa.Column(
            "status", sa.String(50), nullable=False, default="draft"
        ),  # draft, approved, posted, archived
        sa.Column("engagement_metrics", postgresql.JSON(), nullable=True),
        sa.Column(
            "moderation_result", postgresql.JSON(), nullable=True
        ...
        sa.ForeignKeyConstraint(
            ["calibrated_voice_id"], ["calibrated_voices.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["segment_id"], ["audience_segments.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "ix_generated_content_workspace_id", "generated_content", ["workspace_id"]
    )
    op.create_index(
        "ix_generated_content_status", "generated_content", ["workspace_id", "status"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "moderation_type", sa.String(50), nullable=False
        ),  # policy, factuality, plagiarism, brand_safety
        sa.Column("status", sa.String(20), nullable=False),  # passed, flagged, blocked
        sa.Column("confidence", sa.Numeric(3, 2), nullable=True),
        sa.Column(
            "flags", postgresql.ARRAY(sa.String), nullable=True
    ...
    op.create_index(
        "ix_content_moderation_workspace_id", "content_moderation", ["workspace_id"]
    )
    op.create_index(
        "ix_content_moderation_content",
        "content_moderation",
        ["content_id", "content_type"],
    )
    op.create_index(
        "ix_content_moderation_status", "content_moderation", ["workspace_id", "status"]
    )
