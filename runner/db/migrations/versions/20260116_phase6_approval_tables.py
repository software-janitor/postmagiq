...
def upgrade() -> None:
    ...
    op.create_index('ix_post_assignment_history_post_id', 'post_assignment_history', ['post_id'])
    op.create_index('ix_post_assignment_history_workspace_id', 'post_assignment_history', ['workspace_id'])
    op.create_index('ix_post_assignment_history_assigned_by_id', 'post_assignment_history', ['assigned_by_id'])
    ...
    op.create_index('ix_approval_stages_workspace_id', 'approval_stages', ['workspace_id'])
    op.create_index('ix_approval_stages_name', 'approval_stages', ['name'])
    op.create_index('ix_approval_stages_order', 'approval_stages', ['workspace_id', 'order'])
    ...
    op.create_index('ix_approval_requests_submitted_by_id', 'approval_requests', ['submitted_by_id'])
    op.create_index('ix_approval_requests_assigned_approver_id', 'approval_requests', ['assigned_approver_id'])
    ...
    op.create_index('ix_approval_comments_approval_request_id', 'approval_comments', ['approval_request_id'])
    op.create_index('ix_approval_comments_workspace_id', 'approval_comments', ['workspace_id'])
    op.create_index('ix_approval_comments_author_id', 'approval_comments', ['author_id'])
