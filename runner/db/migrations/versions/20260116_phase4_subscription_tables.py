...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "price_yearly", sa.Numeric(precision=10, scale=2), nullable=False, default=0
        ),
        # Limits
        ...
        sa.Column(
            "overage_rate", sa.Numeric(precision=10, scale=2), nullable=False, default=0
        ),
    ...
    op.create_index(
        "ix_subscription_tiers_slug", "subscription_tiers", ["slug"], unique=True
    )
    ...
    op.create_index(
        "ix_account_subscriptions_workspace_id",
        "account_subscriptions",
        ["workspace_id"],
        unique=True,
    )
    op.create_index(
        "ix_account_subscriptions_tier_id", "account_subscriptions", ["tier_id"]
    )
    op.create_index(
        "ix_account_subscriptions_stripe_subscription_id",
        "account_subscriptions",
        ["stripe_subscription_id"],
    )
    op.create_index(
        "ix_account_subscriptions_stripe_customer_id",
        "account_subscriptions",
        ["stripe_customer_id"],
    )
    ...
    op.create_index(
        "ix_usage_tracking_workspace_id", "usage_tracking", ["workspace_id"]
    )
    op.create_index(
        "ix_usage_tracking_period",
        "usage_tracking",
    ...
    op.create_index(
        "ix_credit_reservations_workspace_id", "credit_reservations", ["workspace_id"]
    )
    op.create_index(
        "ix_credit_reservations_usage_tracking_id",
        "credit_reservations",
        ["usage_tracking_id"],
    )
    op.create_index(
        "ix_credit_reservations_resource_type", "credit_reservations", ["resource_type"]
    )
    op.create_index(
        "ix_credit_reservations_idempotency_key",
        "credit_reservations",
        ["idempotency_key"],
        unique=True,
    )
