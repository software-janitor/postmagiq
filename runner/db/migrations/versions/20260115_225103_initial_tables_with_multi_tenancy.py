...
def upgrade() -> None:
    ...
    op.create_index('ix_workspace_memberships_email', 'workspace_memberships', ['email'])
    op.create_index('ix_workspace_memberships_invite_token', 'workspace_memberships', ['invite_token'])
    ...
    op.create_index('ix_active_sessions_token_jti', 'active_sessions', ['token_jti'], unique=True)
    ...
    op.create_index('ix_voice_profiles_workspace_id', 'voice_profiles', ['workspace_id'])
    ...
    op.create_index('ix_writing_samples_workspace_id', 'writing_samples', ['workspace_id'])
    ...
    op.create_index('ix_image_config_sets_workspace_id', 'image_config_sets', ['workspace_id'])
    ...
    op.create_index('ix_workflow_personas_workspace_id', 'workflow_personas', ['workspace_id'])
    ...
    op.create_index('ix_workflow_outputs_output_type', 'workflow_outputs', ['output_type'])
    ...
    op.create_index('ix_workflow_state_metrics_run_id', 'workflow_state_metrics', ['run_id'])
    ...
    op.create_index('ix_image_characters_workspace_id', 'image_characters', ['workspace_id'])
    ...
    op.create_index('ix_character_templates_user_id', 'character_templates', ['user_id'])
    op.create_index('ix_character_templates_workspace_id', 'character_templates', ['workspace_id'])
    ...
    op.create_index('ix_outfit_items_outfit_part_id', 'outfit_items', ['outfit_part_id'])
    ...
    op.create_index('ix_character_outfits_character_id', 'character_outfits', ['character_id'])
    op.create_index('ix_character_outfits_outfit_id', 'character_outfits', ['outfit_id'])
    ...
    op.create_index('ix_scene_characters_character_id', 'scene_characters', ['character_id'])
    ...
    op.create_index('ix_prop_categories_workspace_id', 'prop_categories', ['workspace_id'])
    ...
    op.create_index('ix_scene_prop_rules_prop_category_id', 'scene_prop_rules', ['prop_category_id'])
    ...
    op.create_index('ix_context_prop_rules_prop_category_id', 'context_prop_rules', ['prop_category_id'])
    ...
    op.create_table(
        ...
        sa.Column('import_date', sa.DateTime(), nullable=False, server_default=sa.func.now()),
    ...
    op.create_index('ix_analytics_imports_platform_name', 'analytics_imports', ['platform_name'])
    op.create_index('ix_analytics_imports_user_id', 'analytics_imports', ['user_id'])
    op.create_index('ix_analytics_imports_workspace_id', 'analytics_imports', ['workspace_id'])
    ...
    op.create_index('ix_follower_metrics_metric_date', 'follower_metrics', ['metric_date'])
    op.create_index('ix_follower_metrics_user_id', 'follower_metrics', ['user_id'])
    op.create_index('ix_follower_metrics_workspace_id', 'follower_metrics', ['workspace_id'])
    ...
    op.create_index('ix_audience_demographics_user_id', 'audience_demographics', ['user_id'])
    op.create_index('ix_audience_demographics_workspace_id', 'audience_demographics', ['workspace_id'])
    ...
    op.create_index('ix_post_demographics_external_url', 'post_demographics', ['external_url'])
    op.create_index('ix_post_demographics_user_id', 'post_demographics', ['user_id'])
    op.create_index('ix_post_demographics_workspace_id', 'post_demographics', ['workspace_id'])
    ...
    op.create_index('ix_post_iteration_records_story', 'post_iteration_records', ['story'])
    op.create_index('ix_post_iteration_records_run_id', 'post_iteration_records', ['run_id'])
