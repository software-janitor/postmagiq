...
1. **Respect User Feedback** - If the user has already provided feedback saying they don't have certain details, DO NOT ask for them again.
   ...
   **When you see feedback like this:** Set decision to "proceed" and work with what you have.

2. **User is the Authority** - The user is the authority on their own story. If they say a detail isn't available or isn't important, accept that.
