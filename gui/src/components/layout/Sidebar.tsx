...
const navItems: NavItem[] = [
  ...
  { path: '/image-config', icon: Palette, label: 'Image Config', flag: 'show_image_tools' },
  { path: '/characters', icon: Users, label: 'Characters', flag: 'show_image_tools' },
  { path: '/outfit-bank', icon: Shirt, label: 'Outfit Bank', flag: 'show_image_tools' },
  { path: '/ai-personas', icon: Bot, label: 'AI Personas', flag: 'show_ai_personas' },
  ...
  { path: '/evaluation', icon: BarChart3, label: 'Evaluation', flag: 'show_internal_workflow' },
